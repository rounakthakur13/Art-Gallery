            ...
            <div class="col">
                ...
                <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" enctype='multipart/form-data'>
                    ...
                    <div class="form-group">
                        <label>Name</label>
                        <input type="text" name="name" class="form-control" value="" maxlength="20" required="">
                    ...
                    <label for="exampleFormControlFile1">Upload Image</label>
                        <input type="file" accept=".jpg,.gif,.png" name="file" class="form-control" id="exampleFormControlFile1">
                    </div>
                    <div class="form-group">
